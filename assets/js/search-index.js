var SEARCH_INDEX = [
  {
    ...
    keywords: "2007 prius gen 2 toyota repair guide ownership 2004 2005 2006 2008 2009"
  },
  {
    title: "Repair Guides",
    url: "/repairs/",
    description: "All repair guides for the Gen 2 Toyota Prius.",
    keywords: "repairs guides all list index diy how to fix"
  },
  {
    ...
    keywords: "12v battery auxiliary dead won't start click S46B24R Panasonic small battery under hood"
  },
  {
    ...
    keywords: "ABS VSC brake warning light three amigos actuator pump C2227 skid control brakes"
  },
  {
    ...
    keywords: "OBD2 clear engine light codes check engine Torque app Bluetooth adapter reset scanner P0420"
  },
  {
    ...
    keywords: "speedometer dashboard cluster instrument combination meter repair gauge needle"
  },
  {
    ...
    keywords: "headlight bulb replacement H11 HB3 9005 high low beam headlamp burnt out"
  },
  {
    ...
    keywords: "hybrid battery traction pack replacement P3000 reconditioning refurbished cells NiMH HV battery"
  },
  {
    ...
    keywords: "inverter coolant pump water pump hybrid overheating P0A93 triangle warning red"
  },
  {
    ...
    keywords: "MFD display screen dark black blank DOME fuse multi-function touchscreen navigation"
  },
  {
    title: "Tire Replacements",
    url: "/repairs/tires",
    description: "Tire replacement guide with recommended sizes, costs, and 17-year real-world data.",
    keywords: "tires replacement size 185/65R15 cost Michelin Goodyear Defender alignment rotation"
  },
  {
    ...
    keywords: "weatherstrip door seal window rattle wind noise whistle OEM part rubber trim"
  },
  {
    title: "Failure Timeline",
    url: "/timeline",
    description: "Chronological log of every repair and failure on a high-mileage 2007 Prius.",
    keywords: "timeline failure history repairs chronological log mileage when breaks 200000"
  },
  {
    title: "Tools & Parts",
    url: "/tools",
    description: "Recommended tools, OBD2 scanners, and parts sources for Gen 2 Prius work.",
    keywords: "tools parts OBD2 scanner recommended torque wrench supplies Amazon part number"
  },
  {
    title: "Error Codes",
    url: "/error-codes",
    description: "Common OBD2 and Toyota-specific fault codes for the Gen 2 Prius with plain-English explanations.",
    keywords: "error codes fault OBD2 P0420 P3000 C2227 diagnostic check engine triangle warning code list"
  }
];
